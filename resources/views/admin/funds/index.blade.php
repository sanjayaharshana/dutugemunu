...
@section('content')
    <div class="stat-grid mt">
        <div class="stat"><b>{{ \App\Support\Money::format($total) }}</b><span>Current balance</span></div>
        <div class="stat"><b>{{ \App\Support\Money::format($additions) }}</b><span>Total additions</span></div>
        <div class="stat"><b>{{ \App\Support\Money::format($deductions) }}</b><span>Total deductions</span></div>
