...
@section('content')
    <div class="stat-grid mt">
        ...
        <a class="stat stat--sm" href="{{ route('admin.funds.index') }}" title="{{ $fundBalanceExact }}"><b>{{ $fundBalance }}</b><span>Fund balance</span></a>
        <a class="stat" href="{{ route('admin.messages.index') }}"><b>{{ $unreadMessages }}</b><span>Unread messages</span></a>
    </div>
